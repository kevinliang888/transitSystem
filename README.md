...
## Instruction
1. You can simply run the Main function from source code on IDEs, or download the packed app. Note that configuration.txt has to be in the same directory.
